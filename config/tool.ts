export const ToolConfig = {
  ...
  description:
    "The Temperature Unit Converter tool is a versatile utility that enables users to effortlessly convert temperatures between Celsius, Fahrenheit, and Kelvin scales. This tool provides a seamless experience for users to input a temperature value and choose both the input and output temperature units. Whether it's converting Celsius to Fahrenheit, Kelvin to Celsius, or any other combination, the tool ensures accurate and efficient conversions.",
  userGuides: [
